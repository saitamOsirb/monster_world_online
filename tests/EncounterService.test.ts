...
const species = new Map<string, MonsterSpeciesDefinition>([
  ['common', {
    ...
    artStatus: 'original',
    elements: ['grass'],
    baseStats: { maxHp: 10, attack: 5, defense: 5, specialAttack: 5, specialDefense: 5, speed: 5 },
    statGrowth: { maxHp: 3, attack: 1, defense: 1, specialAttack: 1, specialDefense: 1, speed: 1 },
    catchRate: 0.8,
  ...
  ['rare', {
    ...
    baseStats: { maxHp: 12, attack: 6, defense: 5, specialAttack: 7, specialDefense: 5, speed: 8 },
    statGrowth: { maxHp: 3, attack: 2, defense: 1, specialAttack: 2, specialDefense: 1, speed: 2 },
    catchRate: 0.3,
    growthCurve: 'standard',
    learnset: [{ level: 1, moveId: 'basic-strike' }],
  }],
